              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text("065120006", style: textCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text("Muhammad Taofik", style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text("Opik", style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xFF755799)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    "Kp. Marga Bhakti, No.1, Kelurahan Kertamaya, Kecamatan Bogor Selatan, Bogor, Jawa barat, Indonesia, 16138",
